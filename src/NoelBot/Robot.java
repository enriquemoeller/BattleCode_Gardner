...
abstract class Robot {
    ...
    static Team myTeam;
    static Team enemy;
    static MapLocation[] myArchonSpawns;
    static MapLocation[] enemyArchonSpawns;
    ...
    public static void init(RobotController rc) throws GameActionException {
        ...
        myArchonSpawns = robotController.getInitialArchonLocations(myTeam);
        enemyArchonSpawns = robotController.getInitialArchonLocations(enemy);
    }
